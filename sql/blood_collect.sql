...
-- 테이블 kanghoshin_lis.blood_collect 구조 내보내기
CREATE TABLE IF NOT EXISTS `blood_collect` (
  ...
  CONSTRAINT `blood_collect_ibfk_1` FOREIGN KEY (`specimen_no`) REFERENCES `specimen` (`specimen_no`),
  CONSTRAINT `blood_collect_ibfk_2` FOREIGN KEY (`staff_no`) REFERENCES `staff` (`staff_no`)
