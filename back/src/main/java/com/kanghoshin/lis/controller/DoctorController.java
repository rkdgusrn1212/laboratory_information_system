...
public class DoctorController {
	...
	@PostMapping
	public void createDoctor(@AuthenticationPrincipal PrincipalDetails principalDetasils, @NotNull @Valid @RequestBody CreateDoctorDto createDoctorDto) {
		doctorService.createDoctor(principalDetasils, createDoctorDto);
	}
