...
public interface ResultInputMapper {
	@Select("SELECT specimen.specimen_no as specimenNo, test.test_specimen as testSpecimen, "
			+ "test.test_container as testContainer, patient.patient_no as patientNo, "
			...
			+ "prescription_order.order_date as orderDate, recept_test.staff_no as receptTestStaffNo, "
